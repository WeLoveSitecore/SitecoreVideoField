    ...
    public class VideoEditorForm : DialogForm
    {
        ...
        public void RunExternal(ClientPipelineArgs args)
        {
            ...
            else
            {
                ...
                SheerResponse.ShowModalDialog("/sitecore/shell/Applications/Dialogs/External link.aspx?hdl="+WebUtil.GetQueryString("hdl"), true);
        ...
        public void Run(ClientPipelineArgs args)
        {
            ...
            {
                SheerResponse.ShowModalDialog("/sitecore/shell/Applications/Dialogs/Media link.aspx?hdl="+WebUtil.GetQueryString("hdl"), true);
                args.WaitForPostBack();
            }
        }
